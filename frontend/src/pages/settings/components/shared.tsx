...
export function ReadOnlyField({
  ...
  return (
    <div className="min-w-0">
      ...
      <div
        className={cn(
          "mt-1 truncate rounded-[10px] border border-dashed border-line bg-[color-mix(in_srgb,var(--bg-recessed)_50%,transparent)] px-3 py-2 text-body text-text-primary",
